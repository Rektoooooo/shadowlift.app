  ...
  return (
    <section className="download" id="download" ref={sectionRef}>
      <div className="download-container">
        <div className={`download-content ${inView ? 'animate' : ''}`}>
          ...
          <div className={`download-buttons ${inView ? 'animate' : ''}`}>
            <a href="#" className="download-btn download-btn-appstore">
              ...
              <div className="download-text">
                <span className="download-label">Coming Soon on</span>
                <span className="download-store">App Store</span>
              </div>
            </a>

            <a href="https://testflight.apple.com/join/tCKZRzK9" className="download-btn download-btn-beta">
          ...
          <div className={`download-info ${inView ? 'animate' : ''}`}>
